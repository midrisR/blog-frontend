...
import { MdOutlineArticle, MdPerson, MdSpaceDashboard } from 'react-icons/md';
export default function Sidebar({ sidebarOpen, setSidebarOpen }) {
	const trigger = useRef(null);
	const sidebar = useRef(null);

	const [storedSidebarExpanded, setStoredSidebarExpanded] = useState(false);
		...
		<div>
			...
			<div
				...
				<div className="flex justify-between mb-10 pr-3 sm:px-2">
					...
					{/* Logo */}
					<ActiveLink activeClassName="text-blue-500" href="/" className="block">
						<a>
